...
function Product({title, content, btn_text, img, left}) {
  return (
    <div className={`w-full flex  justify-between   ${left ? 'lg:flex-row flex-col-reverse' : 'flex-col-reverse lg:flex-row-reverse'}`}>
        <div className={`flex items-start flex-col px-4 pb-8 flex-1 my-4 space-y-5`}>
