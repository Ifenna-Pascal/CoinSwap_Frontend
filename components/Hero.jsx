    ...
    <div className='w-full'>
        <div className='lg:py-24 py-16 items-center justify-center flex flex-col space-y-8 lg:space-y-10'>
            ...
            <span className='text-[#939197] px-4 lg:px-20 text-center text-base lg:text-xl font-semibold leading-8 tracking-wide'>
                Tremorcoin is a DEX with a suite of products available in Decentralized Finance Environment. It is the perfect
            ...
            <div className='flex lg:flex-row flex-col space-y-6 lg:space-y-0 space-x-8 lg:max-w-[60%] max-w-[90%] mx-auto'>
                <button className='py-3 bg-[#12FEB7] hover:opacity-100 hover:bg-blend-overlay px-8 rounded-lg text-lg lg:text-xl font-semibold font-Catamaran'> Buy TRC</button>
                <button className='py-3 bg-[#353547] rounded-lg px-8 ronded-lg text-white font-semibold font-Catamaran text-lg lg:text-xl '> What is Tremorcoin</button>
            </div>
